...
#
#	MEMORY LOCATIONS:
#		data_items	contains the data items. A 0 is used to terminate the data
#
.section .data
data_items:	#these are the data items
	.long 3,67,34,222,45,75,54,34,44,33,44,22,11,66,0
...
loop_exit:
#%ebx is the status code for the exit sys call and it already has the maximum number
